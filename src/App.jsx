                ...
                <>
                  ...
                  {user && user.role === "citizen" && (auditItem.citizen?._id === user._id || auditItem.citizen === user._id) && (
                    <div className="p-4 bg-sky-50 border border-sky-100 rounded-xl space-y-3">
                      ...
                      {/* State level tier notification - No further escalation */}
                      {auditItem.tier === "state" && (
                        <div className="p-3 bg-indigo-50/80 border border-indigo-200 rounded-xl text-indigo-900 text-xs">
                          <span className="font-bold block mb-0.5 flex items-center gap-1"><Shield size={12} className="text-indigo-600" /> State Level (Highest Authority Tier)</span>
